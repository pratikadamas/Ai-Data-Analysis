      ...
      <section className="pt-36 sm:pt-40 pb-12 relative z-10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl tracking-normal mb-4 text-[#1d1d1f] dark:text-[#f5f5f7] leading-relaxed">
            <span className="font-kaushan inline-block py-2 px-3 text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 via-[#0071e3] to-[#06b6d4] dark:from-emerald-400 dark:via-blue-300 dark:to-cyan-300 overflow-visible">
              Privacy Policy
            </span>
          </h1>

          <p className="text-base sm:text-lg text-[#6e6e73] dark:text-[#a1a1a6] max-w-2xl mx-auto font-normal">
            Your privacy is our primary concern. Learn how we handle, process, and protect your data. Last updated: {new Date().toLocaleDateString(undefined, { month: 'long', day: 'numeric', year: 'numeric' })}
          </p>
        </div>
      </section>
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none space-y-6">
              ...
              <div className="macos-card p-6">
                <div className="flex items-center space-x-3 mb-3">
                  ...
                  <h3 className="text-xl font-semibold m-0 text-[#262422] dark:text-[#f5f5f7]">1. Data Processing and Ephemeral Storage</h3>
                </div>
              ...
              <div className="macos-card p-6">
                <div className="flex items-center space-x-3 mb-3">
                  ...
                  <h3 className="text-xl font-semibold m-0 text-[#262422] dark:text-[#f5f5f7]">2. AI Integration & Schema-Only Sharing</h3>
                </div>
                <p className="text-sm text-[#6e6e73] dark:text-[#a1a1a6] leading-relaxed font-normal">
              ...
              <div className="macos-card p-6">
                <div className="flex items-center space-x-3 mb-3">
                  ...
                  <h3 className="text-xl font-semibold m-0 text-[#262422] dark:text-[#f5f5f7]">3. Account Information</h3>
                </div>
                <p className="text-sm text-[#6e6e73] dark:text-[#a1a1a6] leading-relaxed font-normal">
              ...
              <div className="macos-card p-6">
                <div className="flex items-center space-x-3 mb-3">
                  ...
                  <h3 className="text-xl font-semibold m-0 text-[#262422] dark:text-[#f5f5f7]">4. Changes to This Policy</h3>
                </div>
                <p className="text-sm text-[#6e6e73] dark:text-[#a1a1a6] leading-relaxed font-normal">
